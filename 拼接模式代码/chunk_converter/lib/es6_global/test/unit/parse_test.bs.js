...
import * as Parse$Chunk_converter from "../../src/Parse.bs.js";
import * as StringTool$Chunk_converter from "../tool/StringTool.bs.js";
...
Meta3d_jest.describe("parse", (function (param) {
        ...
        Meta3d_jest.describe("parseSegment", (function (param) {
                Meta3d_jest.test("parse segment", (function (param) {
                        return Curry._2(Meta3d_jest.Expect.Operators.$eq, Meta3d_jest.Expect.expect(StringTool$Chunk_converter.removeSegmentDataBlankNewLine(Parse$Chunk_converter.parseSegment("../src/basic.glsl", "\n         @top\n         precision highp float;\n         @end\n\n         @define\n         #import \"common_vertex\"\n         @end\n\n\n\n         @varDeclare\n\n         varying vec2 v_mapCoord0;\n\n         varying vec2 v_mapCoord1;\n         @end\n\n         @funcDeclare\n         vec3 getDirectionLightDirByLightPos(vec3 lightPos);\n         @end\n\n         @funcDefine\n         vec3 getDirectionLightDirByLightPos(vec3 lightPos){\n             return lightPos - vec3(0.0);\n         }\n         @end\n\n         @body\n         gl_Position = u_pMatrix * u_vMatrix * mMatrix * vec4(a_position, 1.0);\n         @end\n\n         "))), StringTool$Chunk_converter.removeSegmentDataBlankNewLine([
                                        "basic",
                                        [
                                          "top",
                                          "precision highp float;"
