...
let init = (): Block_manager_res.BlockManagerType.state => {
  ...
  ->registerBlock(
    ...
    Engine_block_res.Main.getDependentBlockProtocolNameMap()->Obj.magic,
  ...
  ->registerBlock(
    ...
    Director_block_res.Main.getDependentBlockProtocolNameMap()->Obj.magic,
  ...
  ->registerBlock(
    ...
    SceneManager_block_res.Main.getDependentBlockProtocolNameMap()->Obj.magic,
  ...
  ->registerBlock(
    ...
    Render_block_res.Main.getDependentBlockProtocolNameMap()->Obj.magic,
    Render_block_res.Main.createBlockState()->Obj.magic,
  )
  ->registerBlock(
    "math_block_protocol_res",
    Math_block_res.Main.getBlockService->Obj.magic,
    Math_block_res.Main.getDependentBlockProtocolNameMap()->Obj.magic,
