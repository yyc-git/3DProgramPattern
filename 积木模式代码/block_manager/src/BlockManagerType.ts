...
export type api = {
  // registerBlock<getBlockServiceFunc, dependentBlockProtocolNameMap, blockState>(state: state, blockProtocolName: blockProtocolName, getBlockServiceFunc: getBlockServiceFunc, dependentBlockProtocolNameMap: dependentBlockProtocolNameMap, blockState: blockState): state,
