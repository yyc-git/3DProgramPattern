...
function traverseResultM(list, f) {
  if (!list) {
    return Result$Commonlib.succeed(/* [] */0);
  }
  var tail = list.tl;
  return Result$Commonlib.bind(Curry._1(f, list.hd), (function (h) {
                return Result$Commonlib.bind(traverseResultM(tail, f), (function (t) {
...
function traverseResultMi(list, f) {
  var _traverse = function (list, i, f) {
    ...
    var tail = list.tl;
    return Result$Commonlib.bind(Curry._2(f, i, list.hd), (function (h) {
                  return Result$Commonlib.bind(_traverse(tail, i + 1 | 0, f), (function (t) {
                                return Result$Commonlib.succeed({
                                            hd: h,
                                            tl: t
                                          });
...
function traverseReduceResultM(list, param, f) {
  ...
  var tail = list.tl;
  return Result$Commonlib.bind(Curry._2(f, param, list.hd), (function (h) {
...
function ignoreTraverseResultValue(traverseResult) {
  return Result$Commonlib.mapSuccess(traverseResult, (function (param) {
...
function includesByFunc(list, func) {
  return OptionSt$Commonlib.isSome(Belt_List.head(Belt_List.filter(list, func)));
}
